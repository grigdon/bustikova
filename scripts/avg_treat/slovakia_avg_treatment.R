...
control_means_vec <- c(
  A = mean(data_slvk_questions$Control_A, na.rm = TRUE),
  B = mean(data_slvk_questions$Control_B, na.rm = TRUE),
  C = mean(data_slvk_questions$Control_C, na.rm = TRUE)
)

experimental_means_vec <- c(
  A = mean(data_slvk_questions$Experimental_A, na.rm = TRUE),
  B = mean(data_slvk_questions$Experimental_B, na.rm = TRUE),
  C = mean(data_slvk_questions$Experimental_C, na.rm = TRUE)
)
...
difference_plot <- ggplot(diff_df, aes(x = question, y = difference)) +
  ...
  coord_flip() +
  labs(title = "Slovakia: Treatment Effect (Experimental - Control)",
